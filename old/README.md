This version uses a variable that changes every frame to determine the progress of the run, it's bad practice since it's unreliable when it comes to the player's FPS.
